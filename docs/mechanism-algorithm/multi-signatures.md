...
| 26 | ExchangeTransactionContract | ExchangeContract.ExchangeTransactionContract | ExchangeTransactionActuator | 🚫 Disabled (Hard-coded rejection by `Manager.java` after v4.8.0.1 fork, PR #6507) | Asset exchange via Bancor exchange pair |
